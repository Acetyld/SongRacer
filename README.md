...
```bash
python3 scripts/generate_demo_media.py --count 5 --duration 30
```
...
- Background:
  - `background.mode`: `sky` | `solid` | `gradient`
...
See `configs/demo_5_racers.json` and `configs/demo_gradient_background.json`.
